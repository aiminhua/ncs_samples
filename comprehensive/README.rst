...
This is an variant version of the comprehensive sample, where the whole BLE stack runs on the network core. This comprehensive example integrates most samples under the folder ``sample``. It contains BLE NUS service, BLE OTA service, dual core interactions, high speed UART(1Mbps) example, 
