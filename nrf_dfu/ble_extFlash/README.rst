...
#. Double click ``zip_generate.bat`` in ``update_zip``.You will get exFlash_norpc.zip as the new image bundle. (If you want to update nRF5340 network core too, edit ``zip_generate.bat`` to uncomment the second line)
