...
By default, this sample works with NCS ``v1.6.*``. To work with other versions of NCS, read **prj.conf** carefully. Open the configurations relating to the specified version
and close the configurations of other versions. Search **NCS** in **prj.conf** to locate the configurations quickly.
	
Before building this sample, enter folder ``sdk_change/ncs_v1.6.*`` and overwrite the same files in the correspondent NCS ``v1.6.*`` folders. If you want to build this sample
