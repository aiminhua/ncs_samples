...
#. Double click ``zip_generate.bat`` in ``update``.You will get nrf_intFlash.zip as the new image bundle. (If you want to update nRF5340 network core too, edit ``zip_generate.bat`` to uncomment the second line)
