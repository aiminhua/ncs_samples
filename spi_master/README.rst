...
To facilitate the test, we put the spis images at ``spi_slave_hex``. The spis pin definitions are shown below.
...
1. Program the spis hex file to a nRF52832DK or nRF52840DK from ``spi_slave_hex``. 
