...
python C:/Nordic/NCS/Master/bootloader/mcuboot/scripts/imgtool.py sign --key root-rsa-2048.pem --header-size 0x200 --align 4 --version 0.0.0+0 --pad-header --slot-size 0xf0000 rtthread.hex app_signed.hex
